...
#define TW_SLA_DATA_ACK   0x60 /* Slave received data and send ACK to master */
#define TW_SLA_ADD_W_ACK  0x80 /* Previously addressed with own SLA+W data has been received ACK has been returned */
...
}enuTWI_ClockFrequency_t;

typedef struct
{
	uint8_t twi_Address;
	enuTWI_ClockFrequency_t twi_Clock;
	enuTWI_Prescaler_t twi_Prescaler;
}TWI_ConfigType;
